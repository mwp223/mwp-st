			...
			5145: function(e, t, n) {
				...
				*/
				! function() {
					...
					e.exports ? (l.default = l, e.exports = l) : "object" === c(n.amdO) && n.amdO ? void 0 === (r = function() {
						return l
		...
		function() {
			...
			function r(r) {
				return D(void 0, void 0, Promise, function() {
					...
					return T(this, function(e) {
						return t = {
							url: R + "/currently-wearing?id=" + document.getElementById("scriptCurrentWearing").getAttribute("userid"),
							retryable: !0,
							withCredentials: !0
						}, n = r.map(function(e) {
							return {
			...
			function a() {
				return document.getElementById("scriptCurrentWearing").getAttribute("userid");
			}
			...
			function o(e) {
				var t, n, r = e.asset,
					e = null === (t = r.itemRestrictions) || void 0 === t ? void 0 : t.includes(b.limited);
			...
			var c = CoreUtilities,
				...
				B = (0, y.withTranslations)(function(e) {
					var t = e.translate,
						n = (0, u.useState)([]),
						e = n[0],
						r = n[1];
					...
					}, s().createElement("h3", null, t(f.currentlyWearing))), s().createElement(i, null), s().createElement(l, {
						assets: e
					}))
				}, w);
			(0, c.ready)(function() {
				t() && (0, e.render)(s().createElement(B, null), t())
			})
		}()
}();
//# sourceMappingURL=https://js.rbxcdn.com/cb523797f04365c9393e-currentWearing.js.map
